<template>
  <div>
    ...
    <!-- 卡片视图区 -->
    <el-card>
      <el-alert show-icon title="警告:只允许为第三级设置相关参数" type="warning" :closable="false"> </el-alert>
      <!-- 选择商品分类区 -->
      <el-row class="cat_opt">
        <el-col>
          ...
          <!-- options用来指定数据源 -->
          <!-- props用来指定配置对象 -->
          <el-cascader expandTrigger="hover" clearable change-on-select v-model="selectedKeys" :options="cateList" :props="cateProps" @change="CateChange"> </el-cascader>
        </el-col>
      </el-row>
    ...
    <el-dialog :title="'添加' + titleText" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      <!-- 添加参数对话框 -->
      <el-form :model="addFrom" :rules="addFromRules" ref="ruleFormRef" label-width="100px">
    ...
    <el-dialog :title="'修改' + titleText" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      <!-- 添加参数对话框 -->
      <el-form :model="editFrom" :rules="editFromRules" ref="ruleFormRef" label-width="100px">
        <el-form-item :label="titleText" prop="attr_name">
  ...
  methods: {
    async getCateList() {
      ...
      if (res.meta.status !== 200) {
        return this.$.messsgae.error('获取商品分类失败')
      }
    ...
    async getParamsData() {
      ...
      if (res.meta.status !== 200) {
        return this.messsgae.error('获取列表失败')
      }
