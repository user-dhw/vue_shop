        ...
        <el-tabs v-model="activeIndex" :tab-position="'left'" :before-leave="beforeTabLeave" @tab-click="tabClicked">
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品分类" prop="goods_cat">
              ...
              <!-- options用来指定数据源 -->
              <!-- props用来指定配置对象 -->
              <el-cascader expandTrigger="hover" clearable change-on-select v-model="addForm.goods_cat" :options="cateList" :props="cateProps" @change="handelChange"> </el-cascader>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <!-- 添加商品按钮 -->
            <el-button type="primary" class="btnEdit" @click="add">添加商品</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
  ...
  methods: {
    ...
    handleRemove(file) {
      ...
      const i = this.addForm.pics.findIndex(x => {
        x.pic === filePath
        //3.调用数组中splice方法，把图片信息对象冲pics中移除
